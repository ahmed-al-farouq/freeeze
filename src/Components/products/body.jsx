...
const Body = () => (
  <section className="body">
    <div className="aside-text">
      ...
      <p>It&lsquo;s a special collection of classic flavories. you can try all of them</p>
    </div>
    ...
    <div className="aside-text">
      <h2>Berry Special</h2>
      <p>It&lsquo;s a special collection of berry ice cream. you can try all of them</p>
    </div>
    ...
    <div className="aside-text">
      <h2>Fruit Blast</h2>
      <p>It&lsquo;s a special collection of Fruit Blast. you can try all of them</p>
    </div>
